...
export default class MemoryGameScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet(`tilesheet`, `images/sokoban_tilesheet.png`, { frameWidth: 64 })
  ...
  checkForMatch() {
    ...
    this.time.delayedCall(1000, () => {
      ...
      if (this.matchesCount >= 4) {
        ...
        this.add.text(this.halfWidth, this.halfHeight + 250, `You Win!`, { fontSize: `60px`, color: `#ffb8bf` })
          .setOrigin(0.5)
  ...
  gameOver() {
    ...
    if (this.countdownTimer == 0) {
      this.add.text(this.halfWidth, this.halfHeight + 250, `You Lose!`, { fontSize: `60px`, color: `#ffb8bf` })
        .setOrigin(0.5)
      this.countdownTimer = undefined
      this.player.active = false
      this.player.setVelocity(0, 0)
